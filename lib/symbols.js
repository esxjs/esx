...
const prePlugins = Symbol('esx.pre-plugin')
const postPlugins = Symbol('esx.post-plugin')
module.exports = {
  ns, marker, skip, provider, esxValues, parent, owner, template, ties, separator, prePlugins, postPlugins
}
